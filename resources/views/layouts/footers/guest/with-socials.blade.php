        ...
        <div class="row">
            <div class="col-8 mx-auto text-center mt-1">
                <p class="mb-0 text-secondary">
                    Copyright © {{ now()->year }} Soft by <a style="color: #252f40;" href="#"
                        class="font-weight-bold ml-1" target="_blank">InfinityGym</a> &amp; <a style="color: #252f40;"
                        href="https://github.com/albertoKanroji" class="font-weight-bold ml-1"
                        target="_blank">albertoKanroji</a>
            </div>
            </p>
        </div>
    </div>
