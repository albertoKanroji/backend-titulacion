...
<<<<<<< HEAD
            ...
            <span class="ms-3 font-weight-bold">Infinity-Tech Admin</span>
=======
            <img src="https://firebasestorage.googleapis.com/v0/b/infinitytech-15a41.appspot.com/o/Logo-min.png?alt=media&token=0e8916f3-607a-48a0-af25-a60ffe88b5d2" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">Infinity-Tech</span>
>>>>>>> b4f13b76d82b1b2ef20e7d346b4ba5d19270049e
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user-profile' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Rutinas Genericas</span>
                </a>
            </li>
            <li class="nav-item pb-2">
