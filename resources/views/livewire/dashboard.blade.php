                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Ejercicios</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Rutinas Perzonalizadas</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {{ $totalRutinasPersonalizadas }}
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total de Videos</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {{ $totalVideos }}
                                    </h5>
                                </div>
                        ...
                        <div class="container border-radius-lg">
                            <div class="row">
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ $totalClientes }}</h4>
                                ...
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ $totalVideos }}</h4>
                                    <div class="progress w-75">
